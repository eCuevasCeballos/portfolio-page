...
import Description8 from "../assets/Descriptions/projects-8.json";
...
const Projects = () => {
  ...
  const projects = {
    ...
    live: [
      ...
      "https://omnifood-p-erick-c.netlify.app/",
    ],
    github: [
      ...
      "https://github.com/eCuevasCeballos/omnifoods-page",
    ],
  };
  ...
  return (
    ...
    <div className="w-full py-10 px-10 items-center" id="projects">
      ...
      <div className="flex justify-between md:w-3/5 md:mx-auto">
        <h3 className="text-black text-2xl font-bold  md:pl-0 md:text-3xl">
          <span className="text-blue font-icon font-semibold px-3">
            &#60;&#47;&#62;
          </span>
          Projects
        </h3>
